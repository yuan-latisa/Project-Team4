    ...
    <div class="container">
      <form method="POST" action="simpan.php">
        ...
        <div class="form-group">
          <label>NIS</label>
          <input type="text" name="nis" placeholder="Jawaban Anda" required>
        </div><br>

        <div class="form-group">
          <label>Nama</label>
          <input type="text" name="nama" placeholder="Jawaban Anda" required>
        </div><br>
        ...
        <div class="form-group">
          <label>No Telp</label>
          <input type="text" name="telp" placeholder="Jawaban Anda" required>
        </div><br>
        ...
        <div class="form-group">
          ...
          <div class="radio-box">
            <label class="radio-row">
              ...
              <input type="radio" name="kategori" value="Game Developer" required>
            </label>

            <label class="radio-row">
              <span>Web Design</span>
              <input type="radio" name="kategori" value="Web Design" required>
            </label>

            <label class="radio-row">
              <span>IT Support</span>
              <input type="radio" name="kategori" value="IT Support" required>
            </label>

            <label class="radio-row">
              <span>Networking</span>
              <input type="radio" name="kategori" value="Networking" required>
            </label>

            <label class="radio-row">
              <span>Cyber Security</span>
              <input type="radio" name="kategori" value="Cyber Security" required>
            </label>
          </div>
        </div>
